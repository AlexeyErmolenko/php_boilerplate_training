...
for [boilerplate_training](https://crm.saritasa.com/projects/general.aspx?ProjectID=???) project
...
## API Documentation
https://apidocs.saritasa.io/?url=boilerplate_training/develop/boilerplate_training-latest.yaml

## Goolge Drive
TODO: setup link

## SonarQube
https://sonarqube.saritasa.com/dashboard?id=boilerplate_training-backend
...
```
mkdir boilerplate_training && cd boilerplate_training
git clone ssh://gitblit.saritasa.com/boilerplate_training/backend.git
cd backend
...
docker ps
```
There should be: boilerplate_training-web, boilerplate_training-db, boilerplate_training-redis
...
(*shortcut for ```docker inspect boilerplate_training-web | grep IPAddress```*) -
